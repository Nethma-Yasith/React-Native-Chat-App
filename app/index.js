      ...
      <ScrollView style={stylesheet.scrol1}>
        ...
        <View style={stylesheet.view2}>
          ...
          <View style={stylesheet.avatar1}>
            <Text style={stylesheet.texeAB}>{getName}</Text>
          ...
          <TextInput style={stylesheet.input1} inputMode={"tel"} maxLength={10} onChangeText={
            ...
            async () => {
              if (getMobile.length == 10) {
                let response = await fetch("http://localhost:8080/SmartChat/GetLetters?mobile=" + getMobile);
          ...
          <Pressable style={stylesheet.pressable1} onPress={
            async () => {
              ...
              let response = await fetch(
                "http://localhost:8080/SmartChat/SignIn",
                {
                  method: "POST",
                  body: JSON.stringify(
                    {
          ...
          <Pressable style={stylesheet.pressable2} onPress={
            ...
            <Text style={stylesheet.buttonText2}>New User ? Create Account</Text>
          </Pressable>
          {/* 
          <Button title={"Hello"} />
          <Button title={"Hello"} />
